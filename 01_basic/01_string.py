...
s3 = 'def'
print("isidentifier: ", s3.isidentifier()) # Return True if the string is a valid Python identifier(keywords), False otherwise.
...
print("rsplit      : ", s.rsplit("W", 10))  # Splits are done starting at the end of the string and working to the front.
...
print("swapcase    : ", s.swapcase())       # Convert uppercase characters to lowercase and lowercase characters to uppercase.
print("title       : ", s.title())
